...
| 项目                | 配置                                                        |
| ------------------- | ----------------------------------------------------------- |
| **工作空间**        | `C:\Users\14015\.openclaw\workspace` (仅配置，不写入大文件) |
...
**C 盘快满了！绝对不要向 C 盘写入文件！**

- ❌ 禁止：大文件、项目物料、备份、node_modules
- ✅ 允许：配置文件、临时运行数据
- 📁 技能存放：`G:\openClaw\xiaoxia\skills`（不是 C 盘 workspace）

---

## ✅ C 盘清理完成（2026-03-05 16:21 最终版）
